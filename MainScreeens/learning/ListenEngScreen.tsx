...
const LESSON_CONTENT = {
  ...
  description: "A typical conversation between colleagues discussing project deadlines and responsibilities.",
...
export default function ListenEngScreen() {
  ...
  const currentContent = mode === 'word' 
    ? LESSON_CONTENT.words 
    : LESSON_CONTENT.sentences;
  ...
  const getColorForType = (type) => {
    const colorSet = WORD_TYPE_COLORS[type] || { light: '#000000', dark: '#FFFFFF' };
  ...
  const getFormattedWord = (word, index) => {
    ...
    const shouldShowSelectedHighlight = mode === 'word' && currentIndex === index;
    ...
    return (
      <TouchableOpacity 
        ...
        style={[
          ...
          isCurrent && styles.currentSentence
        ]}
      >
        <Text style={[
          styles.sentenceText,
          isCurrent && styles.currentSentenceText
        ]}>
          {sentence}
        </Text>
      </TouchableOpacity>
      ...
      >
        {types.map(type => (
          <TouchableOpacity
            ...
            style={[
              styles.typeButton,
              highlightType === type && { backgroundColor: `${getColorForType(type)}50` }
            ]}
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.lessonInfoHeader}>
            ...
            <View style={styles.difficultyBadge}>
              <Text style={styles.difficultyText}>{LESSON_CONTENT.difficulty}</Text>
            </View>
          </View>
          <Text style={styles.lessonSource}>{LESSON_CONTENT.source}</Text>
          <Text style={styles.lessonDescription}>{LESSON_CONTENT.description}</Text>
        </Animated.View>
        ...
        <View style={styles.modeTabsContainer}>
          ...
          >
            <Text style={[styles.modeTabText, mode === 'word' && styles.activeTabText]}>
              Word Mode
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
          ...
          >
            <Text style={[styles.modeTabText, mode === 'sentence' && styles.activeTabText]}>
              Sentence Mode
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.contentContainer}>
          ...
          >
            {mode === 'word' ? (
              ...
              <Text style={styles.displaySentence}>
                {getDisplayText()}
              </Text>
            )}
          </Animated.View>
            ...
            <View style={styles.progressContainer}>
              ...
              <View style={styles.progressBar}>
                <View 
                  style={[
                    styles.progressFill,
                    { width: `${((currentIndex + 1) / currentContent.length) * 100}%` }
                  ]}
                />
              </View>
            </View>
