				...
				>
					...
					>
						...
						<View style={styles.formContainer}>
							<Text style={[styles.welcomeText, { color: colors.neonBlue }]}>
								Welcome to <Text style={{ color: colors.deepBlue }}>Learn</Text>
								<Text style={{ color: colors.accent }}>Eng</Text>
							</Text>
							...
							<View style={styles.signupContainer}>
								...
								<TouchableOpacity onPress={() => navigation.navigate("Signup")}>
									<Text style={[styles.signupLink, { color: colors.neonBlue }]}>
										Sign up
									</Text>
								</TouchableOpacity>
							</View>
