...
const LanguageResult = ({ navigation, route }) => {
  ...
  const [sentencesData, setSentencesData] = useState<TableRow[]>([
    {
      sentences:
        "The classes was the awesome place to learn the new things....",
      integrity: "85%",
      fluency: "88%",
      accuracy: "80%",
      overall: "97%",
    ...
    {
      sentences:
        "Knowing the new things will always keeps us in a good position...",
      integrity: "90%",
      fluency: "78%",
      accuracy: "60%",
      overall: "87%",
  ...
  useEffect(() => {
    // Here you would typically fetch the data based on the parameters
    console.log(`Fetching language results for Student: ${studentId}, Assignment: ${assignmentId}, Class: ${classId}`);
    // For a real implementation, make the API call here
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Language Practice Results</Text>
