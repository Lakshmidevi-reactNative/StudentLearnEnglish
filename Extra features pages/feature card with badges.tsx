						...
						>
							...
							<View style={styles.letterContainer}>
								...
								>
									...
									>
										<Text style={[styles.letterText, { color: feature.color }]}>
							...
							<View style={styles.featureContent}>
								...
								<View style={styles.textContainer}>
									<Text
										style={[styles.featureTitle, isDarkMode && styles.darkText]}
									>
										{feature.title}
									</Text>
									<Text
								...
								<View style={styles.progressSection}>
									...
									<Text style={[styles.progressText, { color: feature.color }]}>
										{feature.progress}%
									</Text>
								</View>
							</View>
					...
					{resources.map((resource, index) => (
						...
						>
							...
							<View style={styles.resourceContent}>
								<Text
									style={[styles.resourceTitle, isDarkMode && styles.darkText]}
								>
									{resource.title}
								</Text>
								<Text
